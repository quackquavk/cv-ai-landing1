        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              average{" "}
              <strong className="text-foreground">68% salary increase</strong>{" "}
              when they land these roles?
            </p>
          ...
          >
            ...
            <ol className="space-y-2 text-muted-foreground list-decimal list-inside">
              ...
              <li>
                <strong className="text-foreground">Continuous matching</strong>{" "}
                monitors thousands of opportunities simultaneously, finding
                matches you'd never discover manually
              </li>
              <li>
                <strong className="text-foreground">Salary transparency</strong>{" "}
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              . If the job description says "React.js" and your resume says
              "React," you might not match. If they're looking for "data
              pipelines" and you wrote "ETL architecture," the system doesn't
              understand these describe the same expertise.
            </p>
            ...
            <p className="text-muted-foreground leading-relaxed">
              <strong className="text-foreground">The bottom line</strong>:
          ...
          >
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="bg-card/60 border border-red-500/20 rounded-lg p-4 mb-4">
