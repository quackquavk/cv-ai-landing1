...
- [ ] **Phase 1: Design System Foundation** - Configure design tokens, typography, shadows, and dark mode in globals.css
- [ ] **Phase 2: Component Migration** - Update buttons, cards, badges, and form inputs to Stripe specs
...
2. sohne-var font is loaded and "ss01" OpenType feature is enabled globally on all text
...
| 2. Component Migration | 0/1 | Not started | - |
